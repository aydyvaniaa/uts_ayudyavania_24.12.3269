...
<div class="max-w-6xl mx-auto px-6 mb-16">
    ...
    <!-- Box Filter -->
    <div class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-[3px] rounded-3xl shadow-2xl">

        <div class="bg-white rounded-3xl px-6 py-8">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-slate-500 mt-2">
                    Temukan event favoritmu berdasarkan kategori pilihan
                </p>
            ...
            <div class="flex flex-wrap justify-center gap-5">
                ...
                <a href="/"
                    ...
                    ? 'bg-gradient-to-r from-indigo-600 to-purple-600 text-white scale-105 shadow-xl shadow-indigo-300' 
                    : 'bg-slate-100 text-slate-700 hover:bg-indigo-100 hover:text-indigo-700' }}
                    px-6 py-3 rounded-2xl font-bold text-sm uppercase tracking-wide transition-all duration-300 hover:scale-105">
...
<section class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="text-center mb-12">
        ...
        <p class="text-slate-500">
            Platform AmikomEventHub didukung oleh berbagai partner terpercaya
        </p>
